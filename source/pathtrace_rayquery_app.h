...
class PathtraceApp : public ISampleApp
{
public:
...
private:
    ...
    void CreateRayQueryPipeline();
    void PrepareModelData();
    void CreateRandomState();
    void CreateBlasGeometryInfo();
    ...
    std::shared_ptr<StorageBuffer>  m_blasGeometryInfo;
    std::shared_ptr<StorageImage2D> m_randomState2D;
    std::shared_ptr<StorageImage2D> m_accumulateImage;
